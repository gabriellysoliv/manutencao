    ...
    <View style={styles.container}>
      ...
      <View style={styles.voltarContainer}>
        <TouchableOpacity onPress={() => router.push('/adminHome')}>
          <AntDesign name="arrowleft" size={24} color="#0053A0" />
        </TouchableOpacity>
      </View>

      <Text style={styles.titulo}>Relatório de Tarefas Finalizadas</Text>
      ...
      <View style={{ padding: 16 }}>
        ...
        {(dataInicio || dataFim) && (
          ...
          >
            <Text style={{ color: '#990000', fontWeight: 'bold' }}>Limpar filtro de datas</Text>
          </TouchableOpacity>
        )}
      </View>
